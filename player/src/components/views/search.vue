          ...
          <tbody>
            ...
            >
              ...
              <td>
                <div class="song-wrap">
                  <div class="name-wrap">
                    <el-button class="icon" type="warning" icon="el-icon-caret-right" circle @click="playMusic(item.id,item.name,item.artists[0].name)"></el-button>
                    <!-- 歌名 -->
                    <span>{{ item.name }}</span>
                    <!-- mv的图标 -->
                    <span v-if="item.mvid != 0" class="icon-mv">
